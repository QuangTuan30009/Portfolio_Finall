    ...
    <div className="container-about">
      ...
      <div className="main">
        <div className="text-section">
          <div className="title">Know Who I'm</div>
          <div className="description">
            <p>
              Hi everyone! I’m <TextStyle>Quang Tuan</TextStyle> from{" "}
              <TextStyle>HCM City, VietNam.</TextStyle> I am an{" "}
              <TextStyle>AI major student at FPT University</TextStyle> with a
              passion for building high-performance, interactive web
              applications. I bridge the gap between complex{" "}
              <TextStyle>Machine Learning</TextStyle> logic and seamless User
              Experience using <TextStyle>React.</TextStyle>
            </p>
